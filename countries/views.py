...
def country_detail_view(request, country_code):
    ...
    if country_code == "JP":
        ...
        city2 = 'Sydney'
        city3 = 'Brisbane'
    city_weather1 = requests.get(
        url.format(city1)).json()  # request the API data and convert the JSON to Python data types
    ...
    url = "https://api.apilayer.com/exchangerates_data/2022-12-15&base=KRW"
    ...
    return render(request, 'countries/detail.html', {'exchange_code': exchange_code,'exchange': exchange, 'country': country,
