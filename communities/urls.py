...
urlpatterns = [
    ...
    path("<str:country_code>/review/<int:article_pk>/review_detail/<int:comment_pk>/comment_update/", views.article_comment_update, name="comment_create"),
    path("<str:country_code>/review/<int:article_pk>/review_detail/<int:comment_pk>/comment_delete/", views.article_comment_delete, name="comment_create"),
